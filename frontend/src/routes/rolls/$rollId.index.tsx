    ...
    return <div className="flex-1 flex flex-col h-full p-2">
        <div className="mb-4 pb-2 border-b border-gray-300 flex justify-between items-center">
            ...
            <div className="flex gap-4 mr-4">
                <Link from={Route.fullPath} to="./recording" className="px-1.5 py-1.5 bg-neutral-300 rounded hover:bg-neutral-400">
                    Analyze
                </Link>
                <Link from={Route.fullPath} to="./edit" className="px-1.5 py-1.5 bg-neutral-300 rounded hover:bg-neutral-400">
