...
function RollGraphs({ speedData, centripetalData, tooltipLeft, tooltipTop, tooltipData, showTooltip, handleMouseLeave }:
    {
        speedData?: GraphData, centripetalData?: GraphData, tooltipLeft?: number, tooltipTop?: number, tooltipData?: TooltipData,
        showTooltip: (args: any) => void, handleMouseLeave: () => void
    }) {
    return <div className="mb-2 h-full relative">
        <ParentSize>
